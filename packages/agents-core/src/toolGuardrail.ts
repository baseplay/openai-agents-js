 ...
 */
export interface ToolOutputGuardrailData<TContext = UnknownContext>
...
export interface ToolInputGuardrailDefinition<TContext = UnknownContext>
  extends ToolGuardrailBase {
  type: 'tool_input';
  run: ToolInputGuardrailFunction<TContext>;
}

export interface ToolOutputGuardrailDefinition<TContext = UnknownContext>
  extends ToolGuardrailBase {
  type: 'tool_output';
